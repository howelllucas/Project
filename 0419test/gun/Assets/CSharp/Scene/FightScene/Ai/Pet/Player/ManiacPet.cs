...
namespace EZ
{
    public class ManiacPet : BasePet
    {

        ManiacAtkState m_AtkState;
        ManiacFlashState m_FlashState; 
        ManiacLockState m_LockState;
        ManiacPursueState m_PursueState;
        ...
        {
            ItemItem petItem = Global.gApp.gGameData.GetItemDataByName(GameConstVal.WManiac);
