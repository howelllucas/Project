...
namespace EZ.Weapon
{
    public class S_BoomTurretGun : SecondSupportGun
    {
        ...
        protected override void Awake()
        {
            ...
            ItemItem weaponItem = Global.gApp.gGameData.GetItemDataByName(GameConstVal.WSFireBoomTurret);
        ...
        //    double atk = weaponLevelData.S_BoomTurret[(int)MWeapon.Atk];
        //    m_Damage = atk;
        //}
