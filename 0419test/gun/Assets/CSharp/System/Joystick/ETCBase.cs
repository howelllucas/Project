...
public abstract class ETCBase : MonoBehaviour
{
    ...
    protected RectTransform cachedCanvasRectTransform;
    ...
    protected virtual void Awake()
    {
        ...
        CanvasScaler scaler;
        cachedCanvasRectTransform = transform.parent.GetComponent<RectTransform>();
    ...
    protected void CameraSmoothFollow()
    {
        ...
        currentRotationAngle = Mathf.LerpAngle(currentRotationAngle, wantedRotationAngle, followRotationDamping * BaseScene.GetDtTime());
        currentHeight = Mathf.Lerp(currentHeight, wantedHeight, followHeightDamping * BaseScene.GetDtTime());
