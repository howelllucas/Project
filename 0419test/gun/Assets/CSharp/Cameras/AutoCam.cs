...
namespace EZ
{
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.localPosition = m_Target.position;
            ...
            //transform.localRotation = Quaternion.Lerp(transform.localRotation, rollRotation, m_TurnSpeed*m_CurrentTurnAmount*deltaTime);
        }
    }
}
