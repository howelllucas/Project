...
namespace EZ
{
    public class BeetlePet : BasePet
    {

        BeetleAtkState m_AtkState;
        BeetleFlashState m_FlashState; 
        BeetleLockState m_LockState;
        BeetlePursueState m_PursueState;
        ...
        public override void Init(GameObject playerGo, int guid)
        {
            ...
            m_AtkState = GetComponent<BeetleAtkState>();
            m_FlashState = GetComponent<BeetleFlashState>();
            m_LockState = GetComponent<BeetleLockState>();
            m_PursueState = GetComponent<BeetlePursueState>();
        ...
        {
            ItemItem petItem = Global.gApp.gGameData.GetItemDataByName(GameConstVal.WBeetle);
