...
namespace EZ
{
    public partial class FightWin
    {
        ...
        private List<FightWin_ResIcon> m_FightWinIcons = new List<FightWin_ResIcon>();
        ...
        private int InitNode()
        {
            ...
            index = AddResIcon(ref SpecialItemIdConstVal.FIGIT_WIN_RES,index);
            if(index == 0)
            {
            ...
            {
                foreach (FightWin_ResIcon fightWin_ResIcon in m_FightWinIcons)
                {
