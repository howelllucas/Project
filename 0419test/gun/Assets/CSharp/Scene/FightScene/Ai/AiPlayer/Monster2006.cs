...
namespace EZ
{
    public class Monster2006 : Monster 
    {
        AISniperrifleAct m_SniperrifleAct;
        private void Awake()
        {
            m_PursureAct = gameObject.GetComponent<AIPursueAct>();
            m_BeatBackAct = gameObject.GetComponent<AIBeatBackAct>();
            m_SniperrifleAct = gameObject.GetComponent<AISniperrifleAct>();
        }
        public override void Init(GameObject player, Wave wave, EZ.Data.MonsterItem monster)
        {
            ...
            m_SniperrifleAct.Init(player, wave,this);
