...
namespace EZ {
	...
	public partial class GunChipUI : BaseUi {
		...
		[SerializeField]
		private RectTransform_Button_Image_Container m_ChooseBtn;
		public RectTransform_Button_Image_Container ChooseBtn { get { return m_ChooseBtn; } }
		...
		[SerializeField]
		private RectTransform_GunChipUI_GunChip_Container m_GunChip;
		public RectTransform_GunChipUI_GunChip_Container GunChip { get { return m_GunChip; } }
		...
		[System.Serializable]
		public class RectTransform_GunChipUI_GunChip_Container {
			...
			[SerializeField]
			private GunChipUI_GunChip m_GunChip;
			public GunChipUI_GunChip GunChip { get { return m_GunChip; } }

			private Queue<GunChipUI_GunChip> mCachedInstances;
			public GunChipUI_GunChip GetInstance() {
				GunChipUI_GunChip instance = null;
				...
				if (instance == null || instance.Equals(null)) {
					instance = Instantiate<GunChipUI_GunChip>(m_GunChip);
				}
			...
			public bool CacheInstance(GunChipUI_GunChip instance) {
				if (instance == null || instance.Equals(null)) { return false; }
				if (mCachedInstances == null) { mCachedInstances = new Queue<GunChipUI_GunChip>(); }
